...
const { getPedidoStock, getAllPedidoStock, getFiltroPedidoStock, updatePedidoStock, createPedidoStock, deletePedidoStock, getReportePdfPedidoStock, filtropedidoBodega, updateStockPedido, updateValidarCantidades } = require("../controllers/pedidoStock");
